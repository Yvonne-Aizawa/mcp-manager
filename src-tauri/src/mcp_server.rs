...
impl McpManagerServer {
    ...
    pub async fn add_mcp_server(&self, name: String, command: String, args: Vec<String>, env: Option<HashMap<String, String>>) -> Result<Value, String> {
    ...
    pub async fn update_mcp_server(&self, name: String, command: String, args: Vec<String>, env: Option<HashMap<String, String>>) -> Result<Value, String> {
        let server_data = McpServerEdit {
            command,
            args,
            env: env.unwrap_or_default(),
    ...
    pub async fn install_preset_server(&self, preset_name: String, api_keys: Option<HashMap<String, String>>) -> Result<Value, String> {
...
pub async fn start_mcp_server(state: AppState) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
